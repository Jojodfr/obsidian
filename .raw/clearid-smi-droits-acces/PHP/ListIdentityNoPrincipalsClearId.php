...
$photo_name = '';
$igg_list = array();
$debug_filename = realpath(dirname(__FILE__)) . DIRECTORY_SEPARATOR . basename(__FILE__, '.php')  . '_' . date("Ymd_His") . '.log';
$csv_filename = realpath(dirname(__FILE__)) . DIRECTORY_SEPARATOR . basename(__FILE__, '.php')  . '_' . date("Ymd_His") . '.csv';
